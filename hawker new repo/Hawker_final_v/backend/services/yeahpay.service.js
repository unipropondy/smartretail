...
class YeahPayService {
    constructor() {
        // ✅ Hardcode the public key directly (from API doc)
...
-----END PUBLIC KEY-----`;
        ...
        // Hardcode the client private key (from Java sample)
...
-----END PRIVATE KEY-----`;
    ...
    async sendRequest({ action, data, deviceSn, salt, appId }) {
        ...
        // Generate signature (salt + sorted JSON)
        ...
        try {
            ...
            try {
                ...
                return { success: false, code: -1, msg: 'Decryption failed' };
            }
